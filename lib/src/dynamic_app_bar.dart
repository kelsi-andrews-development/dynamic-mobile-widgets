...
class DynamicAppBar extends DynamicStatefulWidget implements PreferredSizeWidget {
  ...
  @override
  DynamicAppBarState createState() => DynamicAppBarState();
}

class DynamicAppBarState extends DynamicState<DynamicAppBar> {
