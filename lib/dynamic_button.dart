...
class DynamicButton extends DynamicStatefulWidget {
  ...
  @override
  DynamicButtonState createState() => DynamicButtonState();
}

class DynamicButtonState extends DynamicState<DynamicButton> {
  @override
