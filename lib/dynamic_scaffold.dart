...
class DynamicScaffold extends DynamicStatefulWidget {
  /// ## Both Android and IOS
  ...
  /// You do not need to provide either Widget unless you plan to not use [DynamicStatefulWidget.buildAppBar] constructor.
  ...
  @override
  DynamicScaffoldState createState() => DynamicScaffoldState();
}

class DynamicScaffoldState extends DynamicState<DynamicScaffold> {
  @override
